...
用户:              1013@192.168.0.199
联系方式:       "user" <sip:1013@192.168.0.80:5062;transport=udp;fs_nat=yes;fs_path=sip%013%40192.168.0.80%062%3Btransport%3Dudp>
设备:            Grandstream GXP2000 1.1.6.46
状态:            注册成功（UDP-NAT）（未知）到期时间（2009-09-23 16:37:10）
主机:            FreeSwitch.local
IP地址:         192.168.0.80
端口:            5062
认证用户:      1013
...
用户: 1012@192.168.0.199
联系方式: "user" <sip:1012@192.168.0.41:5062;transport=udp;user=phone;fs_nat=yes;fs_path=sip%012%192.168.0.41%3A5062%3Btransport%udp%3Buser%3Dphone>
代理: Grandstream GXP2000 1.1.5.15
状态: 已注册(UDP-NAT)(未知) 过期(2009-09-23 16:37:12)
主机名: FreeSwitch.local
IP地址: 192.168.0.41
端口: 5062
认证用户: 1012
认证域: 192.168.0.199
...
用户: 1017@192.168.0.199
联系方式: "user" <sip:1017@192.168.0.57:5062;transport=udp;fs_nat=yes;fs_path=sip%17%40192.168.0.57%62%3Btransport%3Dudp>
代理: Grandstream GXP2000 1.1.5.15
状态: 已注册(UDP-NAT)(未知) 过期(2009-09-23 16:37:15)
主机名: FreeSwitch.local
IP地址: 192.168.0.57
端口: 5062
认证用户: 1017
...
```xml
API CALL [sofia（状态配置外部）] 输出结果：
=================================================================================================
名称                      external
域名                      N/A
数据库名称               sofia_reg_external
Pres 主机
拨号计划                  XML
上下文                    public
鉴权域                    auto_to
...
```markdown
    名称                  类型                      数据                       状态
=================================================================================================
   internal            profile          sip:mod_sofia@192.168.0.199:5060         运行中 (0)
   external            profile            sip:mod_sofia@yy.yy.yy.yy:5080         运行中 (0)
   xxx.xxx.xxx.xxx     gateway           sip:8155551212@xxx.xxx.xxx.xxx       注册成功
   default               别名                                      internal         已别名
   192.168.0.199         别名                                      internal         已别名
=================================================================================================
2 个配置文件 2 个别名
```
...
<include>
  ...
  <gateway name="xxx.xxx.xxx.xxx">
    <!-- For another DID -->
    <param name="username" value="8166661313"/>
    <param name="password" value="anotherpassw0rd"/>
    <!-- You'll need this name for another "out-bound calls" extension -->
    <param name="expire-seconds" value="60"/>
    <param name="register" value="true"/>
    <param name="register-transport" value="udp"/>
    <param name="retry-seconds" value="30"/>
...
<include>
  ...
  <gateway name="urban1234">
        ...
        <param name="password" value="另一个密码"/>
        <param name="realm" value="xxx.xxx.xxx.xxx"/>
